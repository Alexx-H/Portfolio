    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state.id} SP:{self.setPoint}"
...
##
greenButton = Button(24, bounce_time=0.3)
...
##
redButton = Button(25, bounce_time=0.3)
...
##
blueButton = Button(12, bounce_time=0.3)
